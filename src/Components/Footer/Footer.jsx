    ...
    <footer className="bg-custom-white-fillstroke font-quicksand text-custom-text-gray text-sm">
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
        ...
        <div className="space-y-3 font-lato">
          <img src={logo} alt="Nest Logo" className="w-[200px] h-[63px]" />
          <p className="ml-2 text-custom-new-gray text-sm">
        ...
        {/* 2. Company */}
        <div>
          <h4 className="font-bold mt-5 text-custom-blue ">Company</h4>
          <ul className="font-lato  text-custom-blue mt-[47px] space-y-4">
        ...
        {/* 3. Account */}
        <div>
          <h4 className="font-bold mt-5 text-custom-blue ">Account</h4>
          <ul className="font-lato  text-custom-blue mt-[47px] space-y-4">
        ...
        {/* 4. Corporate */}
        <div>
          <h4 className="font-bold mt-5 text-custom-blue ">Corporate</h4>
          <ul className="font-lato  text-custom-blue mt-[47px] space-y-4">
        ...
        {/* 5. Popular */}
        <div>
          <h4 className="font-bold mt-5 text-custom-blue ">Popular</h4>
          <ul className="font-lato    text-custom-blue mt-[47px] space-y-4">
        ...
        {/* 6. Install App */}
        <div>
          <h4 className="font-bold  mt-5 text-custom-blue mb-3">Install App</h4>
          ...
          <p className="text-sm mt-4  text-custom-blue">Secured Payment Gateways</p>
        </div>
      </div>
      ...
      <div className="border-t font-lato border-custom-white-stroke mt-6 pt-6">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-between items-center text-center md:text-left gap-y-6 text-custom-text-lightgray text-sm">
          ...
          <div className="flex flex-col items-center md:items-end">
            <p className="text-custom-blue">Follow Us</p>
            <div className="flex gap-3 mt-2">
              <FaFacebookF className="text-custom-green" />
              <FaTwitter className="text-custom-green" />
              <FaInstagram className="text-custom-green" />
              <FaPinterestP className="text-custom-green" />
              <FaYoutube className="text-custom-green" />
            </div>
            <p className="text-sm mt-2 text-custom-text-lightgray">Up to 15% discount on your first subscribe</p>
          </div>
        </div>
      </div>
    </footer>
