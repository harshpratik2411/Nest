...
const Top2 = () => {
  ...
  return (
    ...
    <div className="flex space-x-4 overflow-x-auto sm:flex-wrap">
      ...
      <div className="flex items-center bg-custom-white p-2 rounded-lg w-full sm:w-96">
        <input
          type="text"
          value={searchTerm}
          onChange={handleSearchChange}
          placeholder="Search for items.."
          className="w-full p-2 text-custom-gray rounded-lg text-sm outline-none search-input"
        />
