...
const BannerBottom = () => {
  return (
    <section className="relative  lg:w-[1490px] lg:h-[460px] sm:w-[790px] sm:h-[450px]  mt-4 rounded-lg py-16 px-8 flex flex-wrap justify-center items-center">
          <img src={Banner} alt="" className="absolute  rounded-lg inset-0 w-full  h-full sm:object-cover lg:object-cover" />
