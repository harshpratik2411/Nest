...
const BlogDetailsRow2 = () => {
  return (
    <div className="font-quicksand text-custom-blue px-4 md:px-20 py-10" data-aos="fade-up" data-aos-delay="100">
      ...
      <p className="text-custom-blue font-lato mb-6">
      ...
      {/* TAGS & SHARE SECTION */}
      <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center ml-1 font-quicksand font-bold gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
          <p className="text-custom-text-lightgray font-lato font-semibold text-sm">Share this:</p>
      ...
      {/* AUTHOR BOX */}
      <div className="bg-custom-white-fillstroke p-6 rounded-xl flex flex-col sm:flex-row items-start gap-4 mb-6">
      ...
      <form className="space-y-4 mb-10">
        ...
        <button className="bg-custom-green hover:bg-custom-light-green cursor-pointer text-custom-white font-lato font-bold py-2 px-6 rounded-xl">
          Post Comment
        </button>
      </form>    
      ...
      {['Sienna','Brenna','Gemma'].map((name, idx) => (
        <div key={idx} className="flex flex-col sm:flex-row items-start gap-4 mb-6 bg-custom-white-fillstroke p-4 rounded-xl">
