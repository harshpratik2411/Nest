...
const Contact = () => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
    ...
    <div data-aos="fade-up" className="grid grid-cols-1 mt-16 sm:grid-cols-2 gap-8">
      <div>
      ...
      {/* Map Image */}
      <div data-aos="fade-up" className=" ml-[60px] w-[1350px]">
        <img data-aos="fade-up" src={Banner} alt="Map Banner" className="w-full object-cover" />
      </div>

      {/* Location Cards */}
      <section data-aos="zoomi-in" className="grid grid-cols-1 md:grid-cols-3 font-quicksand gap-6 px-6 lg:px-24 py-12 bg-custom-white">
