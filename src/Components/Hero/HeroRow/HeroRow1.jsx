  ...
  return (
    ...
    <section className="relative  lg:w-[1130px] lg:h-[530px] sm:w-[790px] sm:h-[450px]  ml-2 mt-4 rounded-lg py-16 px-8 flex flex-wrap justify-center items-center">
      ...
      <div className="relative max-w-4xl text-center text-white">
        ...
        <p className="lg:text-xl sm:text-base font-lato text-custom-new-gray lg:-ml-[760px] sm:-ml-[300px] cursor-pointer  mb-6">Sign up for the daily newsletter</p>
        <div className="flex justify-center items-center -ml-[390px]  mt-2 bg-custom-white rounded-full shadow-md lg:max-w-md sm:max-w-sm mx-auto overflow-hidden">
          <input
            type="email"
